...
* **分红基数**： eos_per_ite。 每个 ITE token 能获得多少EOS分红。 计算方式如下， 用生态基金池总额的二十分之一，除以当前ITE token的持有总数。
...
每一次买入，视为对项目的投资行为，有30%的EOS进入生态基金池参与分红，剩余 70%买入ITE token。
每一次卖出，视为放弃对项目的投资，放弃分红权。也无法拿回存入生态基金池的 30%。

另外，ITE token的发行量和保证金较大，所以一开始的价格曲线非常平缓。

大概要有20万EOS进场，才能有30%的涨幅。
大概要有30万EOS进场，才能有50%的涨幅。
大概要有60万EOS进场，才能有100%的涨幅（翻倍）
