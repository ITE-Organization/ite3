(module
 ...
 (data (i32.const 448) "in claim time cooldown\00")
 (data (i32.const 480) "cannot pass end iterator to modify\00")
 (data (i32.const 528) "active\00")
 (data (i32.const 544) "claim profit sharing reward\00")
 ...
 (data (i32.const 1200) "cannot sell negative amount\00")
 (data (i32.const 1232) "no resource row\00")
 (data (i32.const 1248) "insufficient quota\00")
 (data (i32.const 1280) "please wait a moment\00")
 (data (i32.const 1312) "must sell less than max operate amount\00")
 (data (i32.const 1360) "must payout a positive amount\00")
 (data (i32.const 1392) "comparison of assets with different symbols is not allowed\00")
 (data (i32.const 1456) "sell payout\00")
 (data (i32.const 1472) "itedecompany\00")
 (data (i32.const 1488) "sell fee\00")
 (data (i32.const 1504) "itedeveloper\00")
 (data (i32.const 1520) "dev fee\00")
 ...
 (data (i32.const 1712) "invalid sell\00")
 (data (i32.const 1728) "invalid conversion\00")
 (data (i32.const 1760) "unexpected asset symbol input\00")
 (data (i32.const 1792) "get\00")
 (data (i32.const 1808) "The ITE Token sell will start at 2018-08-23T20:00:00\00")
 (data (i32.const 1872) "Invalid token transfer\00")
 (data (i32.const 1904) "Quantity must be positive\00")
 (data (i32.const 1936) "must purchase a positive amount\00")
 (data (i32.const 1968) "buy fee\00")
 (data (i32.const 1984) "must reserve a positive amount\00")
 (data (i32.const 2016) "must reserve less than max operate amount:\00")
 (data (i32.const 2064) "can not hold more than 1% before 15%\00")
